...
Route::get('khuyen-mai',['as'=>'khuyenmai','uses'=>'PageController@getKhuyenmai']);
...
Route::get('dang-ki',['as'=>'signin','uses'=>'PageController@getSignin']);

Route::post('dang-ki',['as'=>'signin','uses'=>'PageController@postSignin']);

Route::get('thong-tin',['as'=>'thongtin','uses'=>'PageController@getInfo']);

Route::post('thong-tin',['as'=>'thongtin','uses'=>'PageController@getInfo']);

Route::get('thong-tin-don-hang',['as'=>'thongtindonhang','uses'=>'PageController@getInfo1']);
